...
before packages are loaded."
  ...
  (use-package gnus
    ...
    (setq gnus-posting-styles
          '(("^nnimap[+]personal:.*"
             (address "mitchell.roe@member.fsf.org")
             (name "Mitchell Roe")
             ("X-Message-SMTP-Method" "smtp mail.riseup.net 587 mitchell.roe@riseup.net"))

            ("^nnimap[+]work:.*"
             (address "mbroe@oakland.edu")
             ("X-Message-SMTP-Method" "smtp smtp.googlemail.com 587 mbroe@oakland.edu"))))
...
If REGION is set, it limits this change to text within the REGION."
